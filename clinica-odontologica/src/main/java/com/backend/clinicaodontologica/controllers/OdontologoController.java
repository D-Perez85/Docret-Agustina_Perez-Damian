...
public class OdontologoController {
    ...
    @PostMapping("/guardar")
    public ResponseEntity<OdontologoSalidaDto> guardarPaciente(@Valid @RequestBody  OdontologoEntradaDto odontologo){
    ...
    public OdontologoSalidaDto actualizarOdontologo(@Valid @RequestBody OdontologoModificacionEntradaDto odontologo){
